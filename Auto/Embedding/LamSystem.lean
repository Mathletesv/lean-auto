...
theorem LamValid.prepend (H : LamValid R lval lctx t)
  ...
  apply Eq.trans (@LamWF.interp_bvarLiftsIdx _ _ _ _ 0 _ ex hl' rfl _ lctxTerm₁ _ _) _
...
-- ⊢ (((LamValid R lval lctx' LamTerm.emb ∧ LamValid R lval lctx' LamTerm.false_ne_true) ∧
--       LamValid R lval lctx' LamTerm.not_true_eq_false ∧ LamValid R lval lctx' LamTerm.not_false_eq_true) ∧
--     (LamValid R lval lctx' LamTerm.false_and_eq_false ∧ LamValid R lval lctx' LamTerm.true_and_eq_id) ∧
--       LamValid R lval lctx' LamTerm.false_or_eq_id ∧ LamValid R lval lctx' LamTerm.true_or_eq_true) ∧
--   LamValid R lval lctx' LamTerm.ofPropSpec

theorem LamThmValid.boolFacts : LamThmValid R lval [] LamTerm.boolFacts := by
  intro lctx'; rw [pushLCtxs_nil]; dsimp [LamTerm.boolFacts]
  -- rw [LamValid.and_equiv R, LamValid.and_equiv R, LamValid.and_equiv R, LamValid.and_equiv R]
  -- rw [LamValid.and_equiv R, LamValid.and_equiv R, LamValid.and_equiv R, LamValid.and_equiv R]
